...
const CardHero = ({
  ...
  return (
    <Box sx={{
      position: 'relative', mb: 1.5, borderRadius: '24px', overflow: 'hidden',
      ...
      <Box sx={{ px: 2.5, pt: 2, pb: 2, position: 'relative', zIndex: 1 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
          <Typography sx={{
            color: 'rgba(255,255,255,0.5)', fontSize: '0.62rem', fontWeight: 800,
          ...
          <Box onClick={() => setMostrar(v => !v)} sx={{
            ...
            fontSize: '0.65rem', lineHeight: 1, userSelect: 'none', transition: 'all 0.2s',
        ...
        <Box sx={{ display: 'flex', alignItems: 'flex-end', gap: 1.2, mb: 1.5 }}>
          <Typography sx={{
            fontSize: '2.3rem', fontWeight: 900, lineHeight: 1, letterSpacing: '-1px', color: '#fff',
          ...
          <Box sx={{
            ...
            <Typography sx={{ fontSize: '0.58rem', fontWeight: 900, color: positivo ? '#4DFFC3' : '#FF8FA3' }}>
        ...
        {temRenda ? (
          <>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 1 }}>
              <Typography sx={{ color: 'rgba(255,255,255,0.55)', fontSize: '0.63rem', fontWeight: 600 }}>
            ...
            <Box sx={{
              mt: 1.2, px: 1.2, py: 0.8, borderRadius: '10px',
              bgcolor: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.12)',
              display: 'flex', justifyContent: 'space-between', gap: 1,
            }}>
              <Typography sx={{ color: 'rgba(255,255,255,0.58)', fontSize: '0.65rem', fontWeight: 700 }}>
                Após pagar pendências
              </Typography>
              <Typography sx={{ color: projetadoPositivo ? '#4DFFC3' : '#FF8FA3', fontSize: '0.67rem', fontWeight: 900 }}>
